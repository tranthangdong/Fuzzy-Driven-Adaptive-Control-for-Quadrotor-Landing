...
class OffboardPrecisionLanding(Node):
    ...
    def fuzzy_controller_7x7(self, h, e):
        ...
        gains = [
            ...
            [0.011, 0.012, 0.013, 0.015, 0.020, 0.015, 0.011],  # EL (Extreme Low)
            [0.011, 0.015, 0.025, 0.035, 0.040, 0.030, 0.020],  # VL (Very Low)
            [0.011, 0.020, 0.030, 0.050, 0.065, 0.050, 0.030],  # L (Low)
    ...
    def timer_callback(self):
        ...
        if self.flight_state == "TAKEOFF":
            ...
            if self.aruco_detected:
                ...
                # Saturation safety jump limiter to prevent mechanical body jerk
                
                # Base max step based on altitudeif e > 0.5 and h > 5.0:
                max_step = 0.02
